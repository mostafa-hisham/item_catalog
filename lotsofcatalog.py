...
categoryItem2 = CategoryItem(user_id=1, name="Veggie Burger",
...
categoryItem1 = CategoryItem(user_id=1, name="French Fries", description="with garlic and parmesan",
                             category=category1)

session.add(categoryItem1)
session.commit()

categoryItem2 = CategoryItem(user_id=1, name="Chicken Burger",
...
categoryItem3 = CategoryItem(user_id=1, name="Chocolate Cake", description="fresh baked and served with ice cream",
                             category=category1)

session.add(categoryItem3)
session.commit()

categoryItem4 = CategoryItem(user_id=1, name="Sirloin Burger", description="Made with grade A beef",
                             category=category1)

session.add(categoryItem4)
session.commit()

categoryItem5 = CategoryItem(user_id=1, name="Root Beer", description="16oz of refreshing goodness",
                             category=category1)

session.add(categoryItem5)
session.commit()

categoryItem6 = CategoryItem(user_id=1, name="Iced Tea", description="with Lemon",
                             category=category1)

session.add(categoryItem6)
session.commit()

categoryItem7 = CategoryItem(user_id=1, name="Grilled Cheese Sandwich",
...
categoryItem8 = CategoryItem(user_id=1, name="Veggie Burger",
...
categoryItem1 = CategoryItem(user_id=1, name="Chicken Stir Fry",
...
categoryItem2 = CategoryItem(user_id=1, name="Peking Duck",
...
categoryItem3 = CategoryItem(user_id=1, name="Spicy Tuna Roll",
...
categoryItem4 = CategoryItem(user_id=1, name="Nepali Momo ",
...
categoryItem5 = CategoryItem(user_id=1, name="Beef Noodle Soup",
...
categoryItem6 = CategoryItem(user_id=1, name="Ramen",
...
categoryItem1 = CategoryItem(user_id=1, name="Pho",
...
categoryItem2 = CategoryItem(user_id=1, name="Chinese Dumplings",
...
categoryItem3 = CategoryItem(user_id=1, name="Gyoza",
...
categoryItem4 = CategoryItem(user_id=1, name="Stinky Tofu",
...
categoryItem1 = CategoryItem(user_id=1, name="Tres Leches Cake",
...
categoryItem2 = CategoryItem(user_id=1, name="Mushroom risotto", description="Portabello mushrooms in a creamy risotto",
                             category=category1)

session.add(categoryItem2)
session.commit()

categoryItem3 = CategoryItem(user_id=1, name="Honey Boba Shaved Snow",
...
categoryItem4 = CategoryItem(user_id=1, name="Cauliflower Manchurian",
...
categoryItem5 = CategoryItem(user_id=1, name="Aloo Gobi Burrito",
...
categoryItem1 = CategoryItem(user_id=1, name="Shellfish Tower",
...
categoryItem2 = CategoryItem(user_id=1, name="Chicken and Rice", description="Chicken... and rice",
                             category=category1)

session.add(categoryItem2)
session.commit()

categoryItem3 = CategoryItem(user_id=1, name="Mom's Spaghetti",
...
categoryItem4 = CategoryItem(user_id=1, name="Choc Full O\' Mint (Smitten\'s Fresh Mint Chip ice cream)",
...
categoryItem5 = CategoryItem(user_id=1, name="Tonkatsu Ramen",
...
categoryItem1 = CategoryItem(user_id=1, name="Lamb Curry",
...
categoryItem2 = CategoryItem(user_id=1, name="Chicken Marsala",
...
categoryItem3 = CategoryItem(user_id=1, name="Potstickers",
...
categoryItem4 = CategoryItem(user_id=1, name="Nigiri Sampler", description="Maguro, Sake, Hamachi, Unagi, Uni, TORO!",
                             category=category1)
...
categoryItem9 = CategoryItem(user_id=1, name="Chicken Fried Steak",
...
categoryItem1 = CategoryItem(user_id=1, name="Boysenberry Sorbet",
...
categoryItem2 = CategoryItem(user_id=1, name="Broiled salmon",
...
categoryItem3 = CategoryItem(user_id=1, name="Morels on toast (seasonal)",
...
categoryItem4 = CategoryItem(user_id=1, name="Tandoori Chicken",
...
categoryItem10 = CategoryItem(user_id=1, name="Spinach Ice Cream",
...
categoryItem1 = CategoryItem(user_id=1, name="Super Burrito Al Pastor",
...
categoryItem2 = CategoryItem(user_id=1, name="Cachapa",
...
categoryItem1 = CategoryItem(user_id=1, name="Chantrelle Toast",
...
categoryItem1 = CategoryItem(user_id=1, name="Guanciale Chawanmushi",
...
categoryItem1 = CategoryItem(user_id=1, name="Lemon Curd Ice Cream Sandwich",
